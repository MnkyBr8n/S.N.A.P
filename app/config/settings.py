# S.N.A.P/app/config/settings.py
"""
...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="SANDBOX_", case_sensitive=False, env_file=".env", extra="ignore")
    ...
    # CORS settings (set via SANDBOX_CORS_ALLOWED_ORIGINS env var)
